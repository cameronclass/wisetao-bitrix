document.addEventListener('DOMContentLoaded', function() {
    ...
    if(document.querySelectorAll('.marketing-review-card__more')){
        document.querySelectorAll('.marketing-review-card__more').forEach(button => {
            button.addEventListener('click', () => {
                button.classList.toggle("_active");
                const textElement = button.closest('.marketing-review-card').querySelector('.marketing-review-card__text');
...
if(document.querySelectorAll('.js-main-menu, .js-secondary-menu')){
    document.querySelectorAll('.js-main-menu, .js-secondary-menu').forEach(container => {
