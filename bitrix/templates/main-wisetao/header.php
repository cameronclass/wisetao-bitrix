...
<head>
    ...
    <meta name="description"
        content="WISETAO предоставляет полный спектр услуг по работе с Китаем: от доставки грузов и производства товаров до бизнес-туров и бухгалтерского сопровождения. Работаем с 2013 года, обеспечивая качественное обслуживание и надежное партнерство.">
    <meta name="keywords"
        content="оптовые поставки из Китая, доставка грузов из Китая, производство товаров в Китае, бизнес-туры в Китай, регистрация компаний в Китае, WISETAO, оптовая доставка, логистика Китай, маркетплейсы Китай, контроль производства Китай">
    <!-- OG tags -->
    ...
    <meta property="og:description"
        content="WISETAO предоставляет полный спектр услуг по работе с Китаем: доставка грузов, производство товаров, бизнес-туры, регистрация компаний, бухгалтерское сопровождение и многое другое.">
    ...
    <script
        src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey=daa45afb-a989-4163-8df6-1b1edba1137d&suggest_apikey=5e11305c-8d8a-4669-9069-5c56422200c1">
    </script>
...
<body>
    ...
    <div id="preloader">
        <dotlottie-player style="width: 120px;height: 120px;" src="<?= SITE_TEMPLATE_PATH ?>/assets/js/preloader.json"
        ...
        <section class="container">
            <div class="main-select">
                ...
                <div class="main-select__circle" style="position: relative">
                    ...
                    <svg class="main-select__circle_1" width="860" height="860" viewBox="0 0 860 860" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <circle cx="430" cy="430" r="428.5" stroke="url(#paint0_linear_2105_84525)" stroke-width="3" />
                        <defs>
                            <linearGradient id="paint0_linear_2105_84525" x1="1.68421e-08" y1="430" x2="866.028"
                                y2="425.479" gradientUnits="userSpaceOnUse">
                    ...
                    <img class="main-select__circle_line" src="<?= SITE_TEMPLATE_PATH ?>/assets/images/home/line.svg"
                        alt="">
                    <img class="main-select__circle_2 scale-up-center-100"
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/images/home/circle-4.svg" alt="">
                    <div class="main-select__logo">
                        <img class="main-select__circle_3 scale-up-rotate-200"
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/home/circle-3.svg" alt="">
                        <img class="main-select__circle_4 scale-up-rotate-300"
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/home/circle-2.svg" alt="">
                        <img class="main-select__circle_5 scale-up-rotate-400"
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/home/circle-1.svg" alt="">
                        <div class="main-select__logo_wrapper scale-up-center-nt-500">
                            <img class="main-select__logo_img"
                                src="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=1.1.1" alt="">
    ...
    <!-- Из Китая -->
    <div
        class="js-left-menu js-secondary-menu <?= (explode('-', $_GET['data-in-menu'])[1] == 'left' ? 'active' : '') ?>">
        <header class="header">
            <div class="container">
            ...
            <div class="container">
                <div class="main-menu__block">
                    ...
                    <button class="mobile-back mobile-back-1">
                        <img class="mobile-back__icon"
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/icons/arrow-left.svg" alt="">
    ...
    <!-- В Китай -->
    <div
        class="js-right-menu js-secondary-menu <?= (explode('-', $_GET['data-in-menu'])[1] == 'right' ? 'active' : '') ?>">
        <header class="header">
            <div class="container">
                <div class="header__block">
                    <a href="#" class="header__logo js-go-index">
    ...
    <? endif; ?>
    <? if (
        $APPLICATION->GetCurPage(false) != '/' && $APPLICATION->GetCurPage(false) != '/menu.php'
        && explode('-', $APPLICATION->GetCurPage(false))[0] != '/hash'
        && explode('-', $APPLICATION->GetCurPage(false))[0] != '/bitrix_include_areas'
    ): ?>
                            ...
                            <div class="main-wall__heading_block">
                                ...
                                <div class="main-wall__heading_text">
                                    ...
                                    <button class="main-wall__heading_icon js-slide-to-calc">
                                        <img class="arrow-animation"
                                            src="/bitrix/templates/main-wisetao/assets/images/icons/arrow-down-log.svg"
                                            alt="">
                                    </button>
                                </div>
                            </div>
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                document.addEventListener('mousemove', function(event) {
                                    ...
                                    elementsUnderCursor.forEach(function(element) {
                                        if (element && element.classList.contains(
                                                'logistic-page')) {
                            ...
                            <div class="page-menu__block active">
                                <div class="page-menu__dot">
                                    <div class="page-menu__dot_block">
                                        <img class="page-menu__dot_img"
                                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/menu-dot.svg" alt="">
