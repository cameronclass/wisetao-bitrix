...
if (is_array($arItem["PROPERTIES"]["TOPICS"]["VALUE_XML_ID"])
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                <div class="marketing-review-card">
                    <div class="marketing-review-card__category"><?=$arItem["PROPERTIES"]["SERVICES"]["VALUE"];?></div>
                    <div class="marketing-review-card__name"><?=$arItem["PROPERTIES"]["REVIEWER_NAME"]["VALUE"];?></div>
                    <div class="marketing-review-card__text"><?= $arItem["PREVIEW_TEXT"]; ?></div>
                    <div class="marketing-review-card__bottom">
                        <div class="marketing-review-card__service">Услуга: <?=$arItem["PROPERTIES"]["SERVICES"]["VALUE"];?></div>
                        <button type="button" class="marketing-review-card__more">
                            <span>Развернуть</span>
                            <img class="marketing-review-card__more_icon" src="<?=SITE_TEMPLATE_PATH?>/assets/images/icons/arrow-down.svg" alt="">
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3">
                <div class="marketing-review-links">
                    ...
                    <div class="marketing-review-links__block">
                        <a href="/in-china/about/reviews/" class="marketing-review-links__item">ЧИТАТЬ ВСЕ ОТЗЫВЫ</a>
    <!--                    --><?// foreach ($arResult["ITEMS"] as $key => $arItem): ?>
    <!--                        --><?//if ($arItem["PROPERTIES"]["REVIEW_TYPE"]["VALUE_XML_ID"] === "REVIEW_FROM_SOCIAL_NET"):?>
    <!--                            <a href="#" class="marketing-review-links__item --><?php //= $arItem["PROPERTIES"]["CLASS_COLOR"]["VALUE"]; ?><!--">--><?php //= $arItem["NAME"]; ?><!--</a>-->
    <!--                        --><?//endif;?>
    <!--                    --><?// endforeach; ?>
                    </div>
                </div>
