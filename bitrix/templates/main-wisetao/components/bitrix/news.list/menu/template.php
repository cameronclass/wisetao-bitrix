...
<div class="main-menu__main">
    ...
    '/' . $section["CODE"] . '/': '#' . $section["CODE"]); ?>" id="<?= $this->GetEditAreaId($section['ID']); ?>" class="main-menu__main_link <?= ($section["CODE"] == $arParams['DATA_IN_MENU'] ? 'active' : '') ?>" data-menu="<?= $section["CODE"]; ?>">
...
<div class="main-menu__second">
    ...
    <div class="main-menu-item <?= ($section["CODE"] == $arParams['DATA_IN_MENU'] ? 'active' : '') ?>" data-menu-content="<?= $section["CODE"]; ?>">
        <div class="main-menu-item__cards">
            ...
            ?>
            <<?= $sOrE['UF_ELEMENT'] ?: 'a'; ?> id="<?= $this->GetEditAreaId($sOrE['ID']); ?>" data-drop="<?= $sOrE['CODE'] ?: ''; ?>" <?= ($sOrE['UF_ELEMENT'] === 'a') ? 'href="/' . $section["PARENT_SECTION_CODE"] .
                '/' . $section["CODE"] .
