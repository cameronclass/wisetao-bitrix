        ...
        <div class="location-card__block">
            ...
            <div class="location-card__content">
                ...
                <div class="location-card__item">
                    ...
                    <a target="_blank" class="ask-panel__btn _telegram" href="https://t.me/+79676433973" onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Telegram'}); return true;">
                        <span>Написать в Telegram</span>
                        <img class="ask-panel__btn_icon" src="<?=SITE_TEMPLATE_PATH?>/assets/images/icons/telegram-neon.png" alt="">
                    </a>
                    <a target="_blank" class="ask-panel__btn _whatsapp" href="https://api.whatsapp.com/send?phone=8613154567328" onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Watsapp'}); return true;">
                    ...
                    <a target="_blank" class="ask-panel__btn _wechat" href="weixin://dl/chat?weixinid=ningdejin777">
                        ...
                        <img class="ask-panel__btn_icon" src="<?=SITE_TEMPLATE_PATH?>/assets/images/icons/wechat-neon.png" alt="">
                    </a>
                    <?endif;?>
                </div>
                <div class="location-card__item">
                    <span>E-mail: </span>
                    <a href="mailto:<?=$arItem['PROPERTIES']['EMAIL']['VALUE']?>" onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'E-mail_button'}); return true;">
