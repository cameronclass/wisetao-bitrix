...
?>
    <div class="content-page__page">
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "blog_articles_from_blog_inside", Array(
            "ACTIVE_DATE_FORMAT" => "d.m.Y",
        ...
        <div class="blog-inside__panel">
            <div class="blog-inside-panel__elements" itemscope itemtype="https://schema.org/Blog">
                <div class="calc-panel" data-aos="fade-up">
                    ...
                    <div class="calc-panel__text">Самостоятельно сделайте расчет доставки за 1 минуту! И выберите оптимальный для вас вариант.</div>
