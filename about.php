                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/1.jpg"
                            ...
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/1.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/11.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/11.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                            <span class="about-workers__title">Татьяна Звонкова</span>
                            <span class="about-workers__text">Руководитель розничного направления в сфере
                                потребительских товаров (маркетплейсы)</span>
                        </span>
                    </div>
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/12.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/12.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/8.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/8.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                            <span class="about-workers__title">Роман</span>
                            <span class="about-workers__text">Руководитель отдела сопровождения (первичный контакт)
                            </span>
                        </span>
                    </div>
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/10.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/10.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/7.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/7.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/9.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/9.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/4.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/4.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
                    ...
                    <div class="swiper-slide">
                        <a class="fancy-link" href="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/6.jpg"
                            data-fancybox="gallery">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/company/6.jpg" class="photo-studio__item"
                                alt="">
                        </a>
                        <span class="about-workers__block">
