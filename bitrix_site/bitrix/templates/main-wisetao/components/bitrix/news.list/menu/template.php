...
<div class="main-menu__main">
    <div class="main-menu__main_list">
        ...
        href="<?= ($section['UF_LINK'] ?
            ...
            '/' . $section["CODE"] . '/': '#' . $section["CODE"]); ?>" id="<?= $this->GetEditAreaId($section['ID']); ?>" class="main-menu__main_link <?= ($section["CODE"] == $arParams['DATA_IN_MENU'] ? 'active' : '') ?>" data-menu="<?= $section["CODE"]; ?>"><?= $section["NAME"]; ?></<?=$section['UF_ELEMENT']; ?>>
    <? endforeach; ?>
</div>
...
<div class="main-menu__second">
    <? foreach ($sectionsAndElements as $section): ?>
    <div class="main-menu-item <?= ($section["CODE"] == $arParams['DATA_IN_MENU'] ? 'active' : '') ?>" data-menu-content="<?= $section["CODE"]; ?>">
        <div class="main-menu-item__cards">
            ...
            ?>
            <<?= $sOrE['UF_ELEMENT'] ?: 'a'; ?> id="<?= $this->GetEditAreaId($sOrE['ID']); ?>" data-drop="<?= $sOrE['CODE'] ?: ''; ?>"
            <?= ($sOrE['UF_ELEMENT'] === 'a') ? 'href="/' . $section["PARENT_SECTION_CODE"] .
                '/' . $section["CODE"] .
            ...
            <?if ($sOrE['ELEMENTS']): ?>
                <div data-drop-content="<?= $sOrE["CODE"]; ?>" class="main-menu-item__dropdown_block">
                    <? foreach ($sOrE['ELEMENTS'] as $element): ?>
                        ...
                        '/' . $section["CODE"] .
                        '/' . $sOrE['CODE'] .
                        '/' . $element["CODE"] . '/'; ?>" class="main-menu-item__dropdown_item" id="<?= $this->GetEditAreaId($element['ID']); ?>">
