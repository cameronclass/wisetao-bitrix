...
<div class="question-block__submit" data-ajax_question_inc="<?= $_SESSION['ajax_question_inc'] ?>">
    ...
    <form name="SIMPLE_FORM_1" class="question-block__form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="question-block__form_block">
            ...
            <button class="main-btn" name="web_form_submit" value="ОТПРАВИТЬ" type="submit"
    ...
    <div class="question-block__contacts">
        ...
        <div class="question-block__contacts_block">
            <a target="_blank" href="https://vk.me/wisetao" class="question-block__contacts_link link-vk"
                onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Vk_messend'}); return true;">Перейти во Вконтакте</a>
            <a target="_blank" href="https://api.whatsapp.com/send?phone=8613154567328" class="question-block__contacts_link link-whatsapp"
                onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Watsapp'}); return true;">Написать в Whatsapp</a>
            <a target="_blank" href="https://t.me/+79676433973" class="question-block__contacts_link link-telegram"
                onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Telegram'}); return true;">Написать в Telegram</a>
        </div>
    </div>
</div>
