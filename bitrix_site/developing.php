    ...
    <div class="content-page__content">
        <div class="error-page">
            <div class="error-page__developing">
                ...
                <div class="error-page__about" data-aos="fade-up">пока что, можете ознакомиться <span class="color-orange">с другими услугами</span> на нашем сайте:</div>
                <div class="error-page__menu" data-aos="fade-up">
                    <?
                    $APPLICATION->IncludeComponent("bitrix:news.list", "in_dev", Array(
