<div class="delivery-type-tittle delivery-type-tittle-cargo">
    Карго
    <div class="delivery-type-tittle-after">
    </div>
</div>
<div class="delivery-type-tittle delivery-type-tittle-white">
    Белая
    <div class="delivery-type-tittle-after">
    </div>
</div>
<ul class="type-of-goods-dropdown-list delivery-types-list delivery-types-list-comparison active cargo" style="background: #626E81;">
    <li>
        <div class="list-elem list-help cargo-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
            ...
            <div class="delivery-values" style="font-size: 12px">
                <div class="cost-elem cargo">
                    <div class="cost">
            ...
            <div class="help-container">
                <svg class="balloon-container balloon-container-white comparison" id="balloon-container" width="259.1022470011404" height="520.1116943482469" viewBox="-0.000019691767818130756 -0.00003952848265953435 259.1022470011404 520.1116943482469" xml:space="preserve">
                    ...
                    <foreignObject x="10" y="10" width="240px" height="490px">
                        <div xmlns="http://www.w3.org/1999/xhtml" style="overflow: auto; height: 100%; width: 100%; text-align: left; white-space: nowrap;">
                            ...
                            <div class="help-text help-text-content-white" style="color: black;">
                                SAIDE: <span class="val-customs">0.6$/КГ</span>
                            </div>
                            <div class="title-help title-white" style="color: black; text-align: center; margin-top: 5px;">ИТОГ:</div>
                            <div class="help-text-content-white" style="color: black;">
                            ...
                            <div class="help-text-content-white" style="color: black;">
                                ЛИЦЕНЗИЯ: <span class="val-customs licence">н/д</span>
                            </div>
                            ...
                            <div class="help-text-content-white" style="height: 80px; overflow-y:auto; border: 1px solid #c07000; top: 120px; border-radius: 6px; white-space: normal; position: relative;">
                                СЕРТИФИКАТ: <span class="val-customs certificate">н/д</span>
                            </div>
                            <div class="help-text-content-white" style="color: black;">
    ...
    <li>
        <div class="list-elem list-help jde-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
                <div class="marker"></div>
                <div class="marker"></div>
            ...
            <div class="help-container">
                <svg class="balloon-container balloon-container-cargo-others comparison" id="balloon-container" width="262.7358922755646" height="301.84014587969517" viewBox="0 0 262.7358922755646 301.84014587969517" xml:space="preserve">
    ...
    <li>
        <div class="list-elem list-help pek-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
                <div class="marker"></div>
                <div class="marker"></div>
    ...
    <li>
        <div class="list-elem list-help dl-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
                <div class="marker"></div>
                <div class="marker"></div>
    ...
    <li>
        <div class="list-elem list-help kit-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
                <div class="marker"></div>
                <div class="marker"></div>
...
<ul class="type-of-goods-dropdown-list delivery-types-list delivery-types-list-comparison active white">
    <li>
        <div class="list-elem list-help cargo-help">
            <div class="overlay-delivery-item"></div>
            <div class="clock" style="z-index: 4">
